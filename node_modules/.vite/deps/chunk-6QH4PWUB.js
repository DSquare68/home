...
var ItemsMixin = (superClass) => class ItemsMixin extends superClass {
  ...
  __itemsRenderer(root, menu) {
    ...
    const listBox2 = this.__getListBox();
    listBox2.innerHTML = "";
    menu.items.forEach((item2) => {
...
var ContextMenuMixin = (superClass) => class ContextMenuMixinClass extends ItemsMixin(superClass) {
  ...
  __preserveMenuState() {
    const listBox2 = this.__getListBox();
    if (listBox2) {
      this.__focusedIndex = listBox2.items.indexOf(listBox2.focused);
      if (this._subMenu && this._subMenu.opened) {
        this.__subMenuIndex = listBox2.items.indexOf(this._subMenu.listenOn);
      }
    }
  }
  /** @private */
  __restoreMenuState() {
    ...
    const listBox2 = this.__getListBox();
    if (listBox2) {
      listBox2._observer.flush();
      if (subMenuIndex > -1) {
        const itemToOpen = listBox2.items[subMenuIndex];
        if (itemToOpen) {
      ...
      this.__focusItem(selectedIndex > -1 ? listBox2.children[selectedIndex] : listBox2.items[focusedIndex]);
    }
  ...
  __focusItem(item2) {
    if (item2) {
      item2.focus({ focusVisible: isKeyboardActive() });
    }
  }
  /** @private */
  __onScroll() {
...
@vaadin/context-menu/src/vaadin-menu-overlay-styles.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6QH4PWUB.js.map
