...
var Popover = class extends PopoverPositionMixin(
  ...
  __onTargetFocusOut(event) {
    if (this._overlayElement.opened && !isLastOverlay2(this._overlayElement)) {
      return;
    }
  ...
  __onOverlayFocusOut(event) {
    if (!isLastOverlay2(this._overlayElement)) {
      return;
    }
...
@vaadin/popover/src/vaadin-popover.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YRWTNH3B.js.map
